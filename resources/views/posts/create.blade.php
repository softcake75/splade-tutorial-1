            ...
            <div class="flex gap-4">
                ...
                <div class="w-1/2 flex flex-col gap-4">
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <button type="submit"
                            class="bg-gray-700 p-2 text-black rounded-md text-sm flex items-center gap-1 hover:bg-gray-800">
                        ...
                        <Link href="/posts"
                            class="bg-rose-700 p-2 text-black rounded-md text-sm flex items-center gap-1 hover:bg-rose-800">
                        <svg xmlns="http://www.w3.org/2000/svg"
